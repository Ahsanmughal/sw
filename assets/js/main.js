// @koala-prepend "../libs/jquery/jquery-3.4.1.min.js";
// @koala-prepend "../libs/bootstrap/popper.js";
// @koala-prepend "../libs/bootstrap/bootstrap.min.js";
// @koala-prepend "../libs/slick/slick.js";
// @koala-prepend "../libs/magnific-popup/jquery.magnific-popup.min.js";
// @koala-prepend "../libs/animsition/animsition.min.js";
// @koala-prepend "../libs/parallax100/parallax100.js";
// @koala-prepend "../libs/countdowntime/moment.min.js";
// @koala-prepend "../libs/countdowntime/moment-timezone.min.js";
// @koala-prepend "../libs/countdowntime/moment-timezone-with-data.min.js";
// @koala-prepend "../libs/countdowntime/countdowntime.js";
// @koala-prepend "../libs/sticky-sidebar/theia-sticky-sidebar.js";
// @koala-prepend "../libs/slide-menu/slide-menu.js";
// @koala-prepend "../libs/bootstrap-select/js/bootstrap-select.min.js";
// @koala-prepend "../libs/datepicker-master/datepicker.js";
// @koala-prepend "../libs/starr/starr.js"
// @koala-prepend "../libs/izitoast/dist/js/iziToast.js";
// @koala-prepend "../libs/typehead/jquery.typeahead.min.js";
        ...
        $('.hun-page .hun-header').each(function() {
            ...
            if(!$header.hasClass('header-inited') || $header.hasClass('reinit-sticky')) {
                ...
                try {
                    ...
                    if($header.hasClass('style-sticky') && $(window).outerWidth() > 300) {
                        destroyStickyHeader();
                        initStickyHeader();
                    }
                    else {
...
document.addEventListener('DOMContentLoaded', function() {
    var menuLeftElem = document.getElementById('test-menu-left');

    var menuLeft = new SlideMenu(menuLeftElem, {
        position: 'left',
        submenuLinkAfter: '<span style="font-size: 85%; float:right">⮞</span> ',
        backLinkBefore: ' <span style="font-size: 85%; float:right">⮜</span> ',
    });
});